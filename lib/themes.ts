...
export const graphicThemes: GraphicTheme[] = [
  {
    ...
    colors: { primary: "#D71920", primaryDark: "#8F0F15", accent: "#D4A72C", background: "#080808", surface: "#151515", text: "#FFFFFF", muted: "#A1A1AA" },
  ...
  },
  {
    ...
    colors: { primary: "#EF233C", primaryDark: "#9B1020", accent: "#E5B83A", background: "#050608", surface: "#111318", text: "#FFFFFF", muted: "#9CA3AF" },
  ...
  },
  {
    ...
    colors: { primary: "#B5121B", primaryDark: "#6F0A10", accent: "#C99B2E", background: "#101010", surface: "#1B1B1B", text: "#FFFFFF", muted: "#A3A3A3" },
