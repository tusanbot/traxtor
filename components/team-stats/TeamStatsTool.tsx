...
export default function TeamStatsTool() {
  ...
  const reset = () => { setTeam("تراکتور"); setTournament("لیگ برتر ایران"); setLogo(""); setSubtitle("آمار فصل"); setStats([{ label:"بازی",value:"30"},{label:"برد",value:"18"},{label:"مساوی",value:"7"},{label:"باخت",value:"5"},{label:"گل زده",value:"52"},{label:"گل خورده",value:"24"},{label:"امتیاز",value:"61"},{label:"کلین‌شیت",value:"13"}]); setCustomLabel(""); setCustomValue(""); setBrand("tractorfan1970"); };
  ...
  return <main className="min-h-screen bg-[#070707] px-4 py-8 text-white"><div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[400px_1fr]">
    <section className="rounded-3xl border border-white/10 bg-[#111] p-5"><div className="mb-6"><span className="text-xs font-bold tracking-widest text-[#d4a72c]">TRAXTOR TEAM STATS</span><h1 className="mt-2 text-2xl font-black">آمار تیم</h1></div>
      <div className="space-y-4">
        ...
        <input value={brand} onChange={e=>setBrand(e.target.value.replace(/^@/,""))} className="w-full rounded-xl bg-black/40 px-4 py-3" placeholder="آیدی رسانه"/>
